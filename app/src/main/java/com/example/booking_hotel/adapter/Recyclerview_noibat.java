...
public class Recyclerview_noibat extends RecyclerView.Adapter<Recyclerview_noibat.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.item_ten_idroom.setText(filterList.get(position).getIdroom());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView imvHSP;
        TextView txtTSP, Gia, item_ten_idroom;
        CoordinatorLayout t;
        CardView cardView;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            item_ten_idroom=itemView.findViewById(R.id.item_ten_idroom);
